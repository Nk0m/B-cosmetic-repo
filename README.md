...
It displays the products that people can shop , add to the cart.
<img src="Screenshot 2.png" width="800px">
<h3>The footer page</h3>
...
<h2>Unfixed Bugs</h2>
the navigation bar : media query for smartphone, small devise (max-width:900px) is not working. 
...
all images are from Canva website.
